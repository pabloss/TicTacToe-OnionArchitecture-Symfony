...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = array(), $containerDir = __DIR__)
    {
        ...
        $this->fileMap = array(
            'App\\Presentation\\Web\\Pub\\Controller\\HomeController' => 'getHomeControllerService.php',
    ...
    protected function getTwigService()
    {
        ...
        $a->addPath('/application/src/Presentation/Web/Backoffice/Twig', 'BackOffice');
        $a->addPath('/application/src/Presentation/Web/Pub/Twig', 'Pub');
        ...
        $this->services['twig'] = $instance = new \Twig\Environment($a, array('paths' => array('/application/src/Presentation/Web/Backoffice/Twig' => 'BackOffice', '/application/src/Presentation/Web/Pub/Twig' => 'Pub'), 'debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception::showAction', 'form_themes' => $this->parameters['twig.form.resources'], 'autoescape' => 'name', 'cache' => ($this->targetDirs[0].'/twig'), 'charset' => 'UTF-8', 'default_path' => '/application/templates', 'date' => array('format' => 'F j, Y H:i', 'interval_format' => '%d days', 'timezone' => NULL), 'number_format' => array('decimals' => 0, 'decimal_point' => '.', 'thousands_separator' => ',')));
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'doctrine_migrations.dir_name' => '/application/src/Infrastructure/Persistence/Doctrine/Migrations',
            'doctrine_migrations.namespace' => 'App\\Infrastructure\\Persistence\\Doctrine\\Migrations',
